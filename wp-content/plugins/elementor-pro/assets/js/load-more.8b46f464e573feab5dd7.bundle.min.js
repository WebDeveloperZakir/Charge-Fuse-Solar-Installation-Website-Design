        ...
        2245: (e, t, s) => {
            ...
            class LoopLoadMore extends n.default {
                ...
                afterInsertPosts(e, t) {
                    super.afterInsertPosts(e), ElementorProFrontendConfig.settings.lazy_load_background_images && document.dispatchEvent(new Event("elementor/lazyload/observe")), this.handleDynamicStyleElements(t), (0, r.default)(e), elementorFrontend.elements.$window.trigger("elementor-pro/loop-builder/after-insert-posts")
                }
            ...
            class LoadMore extends elementorModules.frontend.handlers.Base {
                ...
                handleSuccessFetch(e) {
                    ...
                    const t = this.getSettings("selectors"),
                        ...
                        o = e.querySelector(`[data-id="${this.elementId}"] .e-load-more-anchor`).getAttribute("data-next-page");
                    s.forEach((e => this.elements.postsContainer.append(e))), this.elements.loadMoreAnchor.setAttribute("data-page", this.currentPage), this.elements.loadMoreAnchor.setAttribute("data-next-page", o), this.currentPage === this.maxPage && this.handleUiWhenNoPosts(), this.afterInsertPosts(s, e)
                }
                handlePostsQuery() {
